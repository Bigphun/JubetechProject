  ...
  function prepareSignup(event: React.FormEvent) {
    ...
    if (ref_code.trim().length === 0) {
      Swal.fire({
        ...
        text: "กรุณาทำการยืนยันอีเมลก่อนสมัครสมาชิก",
        icon: "error",
      });
    } else {
      Swal.fire({
      ...
      try {
        ...
        if (email.trim().length > 0 && validateMail) {
          ...
          const response = await axios.post(
            `${import.meta.env.VITE_API_URL}/request/otp`,
            { email }
          );
  ...
  return (
    <div className="signup-form-container">
      ...
      <span className="auth-description">
        ลงทะเบียนผู้ใช้งานเพื่อเริ่มต้นในการเป็นสมาชิกภายในแอปพลิเคชั่นและเรียนรู้คอร์สเรียนของเรา
      </span>
      <form id="signup-section" onSubmit={prepareSignup}>
        <div className="row">
          <div className="col-12 col-lg-6">
            ...
            <div className="fname-signup form-group">
              <label htmlFor="firstname_signup">
              ...
              <div className="input-group">
                ...
                <input
                  ...
                  value={firstname}
                  onChange={(event) =>
                    handleSignupChange(event.target.value, "firstname")
                  }
                  required
                />
              </div>
            ...
            <div className="lname-signup form-group">
              ...
              <div className="input-group">
                <input
                  ...
                  value={lastname}
                  onChange={(event) =>
                    handleSignupChange(event.target.value, "lastname")
                  }
                  required
                />
              </div>
        ...
        <div className="name-error">
          <span className="fname-error text-danger"></span>
          <br />
        ...
        <div className="email-signup form-group">
          ...
          <div className="input-group">
            ...
            <input
              ...
              value={email}
              onChange={(event) =>
                handleSignupChange(event.target.value, "email")
              }
              required
            />
          </div>
        ...
        <div className="password-signup form-group">
          ...
          <div className="input-group">
            ...
            <input
              ...
              value={password}
              onChange={(event) =>
                handleSignupChange(event.target.value, "password")
              }
              required
            />
          </div>
        ...
        <div className="confirm-password-signup form-group">
          ...
          <div className="input-group">
            <input
              ...
              maxLength={150}
              onChange={(event) =>
                handleSignupChange(event.target.value, "confirm_password")
              }
              required
            />
          </div>
        ...
        <div className="otp-signup form-group">
          ...
          <div className="input-group">
            <input
              ...
              max={999999}
              onChange={(event) =>
                handleSignupChange(event.target.value, "otp")
              }
              required
            />
        ...
        <br />
        {timeLeft !== 0 ? (
          <span className="count-otp">
            สามารถส่งอีกครั้งภายใน {timeLeft} วิ
          </span>
        ) : (
          ""
        )}
